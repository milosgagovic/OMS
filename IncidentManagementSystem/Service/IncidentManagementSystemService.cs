...
namespace IncidentManagementSystem.Service
{
	public class IncidentManagementSystemService
	{
		...
		private void LoadCrews()
		{
			...
			Crew c1 = new Crew() { Id = "1", CrewName = "Crew_1" };
			Crew c2 = new Crew() { Id = "2", CrewName = "Crew_2" };
			Crew c3 = new Crew() { Id = "3", CrewName = "Crew_3" };
			Crew c4 = new Crew() { Id = "4", CrewName = "Crew_4" };
			Crew c5 = new Crew() { Id = "5", CrewName = "Crew_5" };
			crews.Add(c1);
			crews.Add(c2);
			crews.Add(c3);
			crews.Add(c4);
